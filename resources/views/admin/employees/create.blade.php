                    ...
                    <form action="{{ route('employees.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input @error('employment_at') is-invalid @enderror" id="employment_at" name="employment_at" value="{{ old('employment_at') }}" data-target="#reservationdate" data-toggle="datetimepicker" placeholder="дд.мм.рр">
                            </div>
                            @error('employment_at')
                            <div class="text-danger text-sm-left">{{ $message }}</div>
                            @enderror
