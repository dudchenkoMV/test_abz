...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        initDelegatedMapEvents: function() {
             ...
             * Note: timeout filtering is small to update the Tooltip positions fast
             */
        ...
        /*
         * Map a mouse positions to a map positions
         ...
         * zoomOptions.fixedCenter  set to true in order to preserve the positions of x,y in the canvas when zoomed
         *
        ...
        elemHover: function (elem, event) {
            ...
            /* Handle tooltip positions update */
        ...
        /*
         * Get the coordinates of the text relative to a bbox and a positions
         * @param bbox the boundary box of the element
         * @param textPosition the wanted text positions (inner, right, left, top or bottom)
