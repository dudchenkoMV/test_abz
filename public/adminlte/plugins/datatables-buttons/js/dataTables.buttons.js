...
$.extend( Buttons.prototype, {
	...
	_popover: function ( content, hostButton, inOpts, e ) {
		...
		if ( existingExpanded.length ) {
			// Reuse the current positions if the button that was triggered is inside an existing collection
		...
		if (position === 'absolute') {
			...
			// Set the initial positions so we can read height / width
			...
			// First positions per the class requirements - pop up and right align
			if (options.dropup) {
			...
			// Fix positions - centre on screen
