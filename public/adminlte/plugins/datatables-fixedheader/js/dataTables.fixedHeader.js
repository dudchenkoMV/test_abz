...
$.extend( FixedHeader.prototype, {
	...
	/**
	 * Recalculate the positions of the fixed elements and force them into place
	 */
	...
	/**
	 * This method sets the sticky positions of the header elements to match fixed columns
		...
		if (this._scrollEnabled()) {
			...
			el.find('th').each(function() {
				...
				if ($(this).css('position') === 'sticky') {
					...
					if (right !== 'auto' && !rtl) {
						// New positions either adds or dismisses the barWidth
	...
	_modeChange: function ( mode, item, forceChange )
	{
		...
		if ( mode === 'in-place' ) {
			...
			// Fix the positions of the floating header at base of the table body
			this._clone( item, forceChange );
			...
			// Fix the positions of the floating footer at top of the table body
			this._clone( item, forceChange );
