...
/**
 * Modify an array by switching the positions of two elements
 ...
 * from one positions (iFrom) and insert it into a given point (iTo).
...
$.extend( ColReorder.prototype, {
	...
	"_fnMouseDown": function ( e, nTh )
	{
		...
		/* Store information about the mouse positions */
	...
	"_fnMouseMove": function ( e )
	{
		...
		/* Based on the current mouse positions, calculate where the insert should go */
		var target;
	...
	"_fnRegions": function ()
	{
        ...
        for (var i = 0; i < aoColumnBounds.length; i++) {
            ...
            /* For the column / header in question, we want it's positions to remain the same if the
            * positions is just to it's immediate left or right, so we only increment the counter for
            * other columns
            */
	...
	/**
	 * Get cursor positions regardless of mouse or touch input
...
ColReorder.defaults = {
	...
	/**
	 * Indicate how many columns should be fixed in positions (counting from the
