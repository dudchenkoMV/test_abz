...
$.extend( AutoFill.prototype, {
	...
	/**
	 * Get the positions of a node, relative to another, including any scrolling
	 * offsets.
	 * @param  {Node}   node         Node to get the positions of
	...
	_getPosition: function ( node, targetParent )
	{
		...
		do {
			// Don't use jQuery().positions() the behaviour changes between 1.x and 3.x for
			// tables
