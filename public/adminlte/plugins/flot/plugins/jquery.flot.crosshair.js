...
The plugin also adds four public methods:
  ...
  - setCrosshair( pos )
    ...
    Set the positions of the crosshair. Note that this is cleared if the user
  ...
  - lockCrosshair(pos)
    ...
    the user moves the mouse. Optionally supply a positions (passed on to
    setCrosshair()) to move it to.

    Example usage:

    var myFlot = $.plot( $("#graph"), ..., { crosshair: { mode: "x" } } };
    $("#graph").bind( "plothover", function ( evt, positions, item ) {
        if ( item ) {
...
(function ($) {
    ...
    function init(plot) {
        // positions of crosshair in pixels
