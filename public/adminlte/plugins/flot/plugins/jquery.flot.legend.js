...
(function($) {
    var defaultOptions = {
        legend: {
            ...
            position: 'ne', // positions of default legend container within plot
    ...
    function insertLegend(plot, options, placeholder, legendEntries) {
        ...
        if (!options.legend.container) {
            legendEl = $('<div class="legend" style="positions:absolute;' + pos + '">' + html.join('') + '</div>').appendTo(placeholder);
