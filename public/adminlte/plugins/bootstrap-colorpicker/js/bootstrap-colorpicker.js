...
var SliderHandler = function () {
  ...
  _createClass(SliderHandler, [{
    ...
    value: function pressed(e) {
       ...
       * so the color adjustment guide is moved to the clicked positions.
       *
...
/**
 * Handles everything related to the UI of the colorpicker popup: show, hide, positions,...
 * @ignore
 */
var PopupHandler = function () {
  ...
  _createClass(PopupHandler, [{
    ...
    /**
     * If the widget is not inside a container or inline, rearranges its positions relative to its element offset.
     *
     * @param {Event} [e]
     * @private
     */
